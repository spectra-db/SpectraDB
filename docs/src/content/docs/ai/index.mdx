...
head: []
title: AI Runtime
description: TensorDB's embedded Tier-0 AI runtime with risk scoring, insights, and advisors.
---

TensorDB includes an embedded AI runtime that operates in-process alongside the storage engine. This is a **Tier-0** design — AI computation runs inside the database, not as an external service.
