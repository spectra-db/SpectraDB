...
description: AI-guided compaction optimization in TensorDB.
---
...
The advisor is passive — it observes and reports, but doesn't automatically modify compaction behavior. Its suggestions include:
